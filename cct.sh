...
_cct_off() {  # sticky 해제: 저장 파일 삭제 + 현재 셸 env 해제
  ...
  unset CLAUDE_CODE_OAUTH_TOKEN ANTHROPIC_OAUTH_TOKEN CLAUDE_CODE_DISABLE_ADVISOR_TOOL CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC CLAUDE_CODE_DISABLE_BACKGROUND_PLUGIN_REFRESH
